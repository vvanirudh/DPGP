function sparseGP = build_sparseGP_tau_neural(x_obs, y_obs, tau_obs, ...
                                              speed, hyperparam_0, ...
                                              ifShift)
    ...
    %% initialization
    gkt = Gaussian_kernel(x_obs(1), y_obs(1), x_obs(1), ...
                          y_obs(1),sparseGP.hyperparam);
    
    gkt = gkt.*Neural_Network_kernel(tau_obs(1), tau_obs(1), ...
                                    sparseGP.hyperparam);
    
    %gkt = gkt+Neural_Network_kernel(tau_obs(1), tau_obs(1), ...
    %                                sparseGP.hyperparam);
    
    gkt_0 = Gaussian_kernel(x_obs(1), y_obs(1), x_obs(1), ...
                            y_obs(1), sparseGP.hyperparam, 0);
    
    gkt_0 = gkt_0.*Neural_Network_kernel(tau_obs(1), tau_obs(1), ...
    ...
    for i=2:n
        ...
        kx = Gaussian_kernel(sparseGP.BV_x, sparseGP.BV_y, ...
                             x_obs(i), y_obs(i),sparseGP.hyperparam, ...
                             0);
        
        kx = kx.*Neural_Network_kernel(sparseGP.BV_tau, tau_obs(i), ...
                                        sparseGP.hyperparam, 0);
        ...
        kxx = Gaussian_kernel(x_obs(i), y_obs(i), ...
                              x_obs(i), y_obs(i),  ...
                              sparseGP.hyperparam, 0);
        
        
        kxx = kxx.* Neural_Network_kernel(tau_obs(i), tau_obs(i), ...
                                          sparseGP.hyperparam, 0);

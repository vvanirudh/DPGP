function plotSparseGP_array(sparseGPs, max_shown_pattern, ifLoc_in)
...
for i = 1:n
    ...
    if (ifLoc == 0)
        plotSparseGP( X_query, Y_query, x_vel_sparse, y_vel_sparse,  sparseGPs(i).data.x, sparseGPs(i).data.y, ...

function [mu, var] = sparseGP_predict_tau(sparseGP, x_query, y_query, ...
    ...
    kx = Gaussian_kernel_tau(x_query, y_query, tau_query, sparseGP.BV_x, ...
                             sparseGP.BV_y, sparseGP.BV_tau, hyperparam, ...
                             0);
        
    kxx = Gaussian_kernel_tau(x_query, y_query, tau_query, x_query, ...
                              y_query, tau_query, hyperparam, 1);    
    ...
    %kx_aug = Gaussian_kernel_tau(in_query_aug, in_bv, hyperparam,0);
